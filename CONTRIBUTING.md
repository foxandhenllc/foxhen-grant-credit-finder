# Contributing to Grant Credit Finder

Grant Credit Finder is part of the Fox & Hen public tool set. Contributions should keep the project useful, inspectable, forkable, and safe to demonstrate in public.

## Good First Contributions

- Add or improve a synthetic sample scenario that demonstrates: A tracker for grant and AI-credit opportunities by eligibility, deadline, value, friction, and readiness.
